...
const styles = StyleSheet.create({
  ...
  cardTitle: { fontFamily: type.serif, fontSize: 18, color: colors.onSurface, fontWeight: "700" },
  cardBody: { fontFamily: type.sans, fontSize: 16, color: colors.onSurface, lineHeight: 22, fontWeight: "500" },
  cardMeta: { fontFamily: type.sans, fontSize: 13, color: colors.onSurfaceSoft, marginTop: 4, fontWeight: "600" },
  circleRow: { flexDirection: "row", flexWrap: "wrap", gap: spacing.sm, marginTop: 4 },
  chip: { backgroundColor: colors.surfaceSecondary, borderWidth: 1, borderColor: colors.border, paddingHorizontal: 14, paddingVertical: 8, borderRadius: radius.pill },
  chipText: { fontFamily: type.sans, fontSize: 14, color: colors.onSurface, fontWeight: "700" },
  callBtn: {
    backgroundColor: colors.surface, borderRadius: radius.pill, paddingVertical: 18,
    flexDirection: "row", alignItems: "center", justifyContent: "center", gap: spacing.sm,
    marginTop: spacing.md, borderWidth: 2, borderColor: colors.surface, ...shadow.card,
  },
  callText: { fontFamily: type.sans, color: colors.clayRed, fontWeight: "900", fontSize: 18 },
});
